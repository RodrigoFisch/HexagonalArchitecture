package com.rodrigofisch.hexagonal.architecture.adapters.in.controller;

import com.rodrigofisch.hexagonal.architecture.adapters.in.controller.mapper.CustomerMapper;
...
public class CustomerController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<CustomerResponse> fidById(@PathVariable final String id){
